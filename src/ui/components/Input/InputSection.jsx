        ...
        <div
            ...
            <section
                ...
                <div
                    ...
                    onPaste={handlePaste}
                    className="h-fit min-h-[48px] h-auto max-h-[28vh] w-full overflow-y-auto scrollbar-custom scroll-smooth py-1 px-[4%] md:py-3 md:pl-[2%] md:pr-[7%] border border-teal-400 dark:border-teal-600 rounded-lg focus:outline-none focus:border-2 bg-gray-50 dark:bg-[#0a0a1f] dark:text-white pb-2 transition-all duration-1000 active:outline-none resize-none text-normal placeholder-sm"
                ></div>
