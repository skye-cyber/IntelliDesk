...
import { HTML2Jpg, HTML2Pdf } from '../../../core/export/exportResponse.ts';
                ...
                <div className="relative" ref={exportMenuRef}>
                    ...
                    {showExportMenu && (
                        <div
                            ...
                            className="absolute bottom-full left-0 mb-2 w-48 bg-white dark:bg-primary-800 rounded-xl shadow-lg border border-gray-200 dark:border-primary-700 overflow-hidden z-10">
                            <button
                                onClick={() => { }}
                                className="hidden w-full px-4 py-2 text-left text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-primary-700 transition-colors flex items-center gap-2"
                            >
                                <Printer className="w-4 h-4" fill="none" stroke="currentColor" />
                                Print
                            </button>
                            <button
                                onClick={() => HTML2Pdf(messageref.current, { IsDarkTheme: StateManager.get('isDarkTheme') })}
                                className="w-full px-4 py-2 text-left text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-primary-700 transition-colors flex items-center gap-2"
                            >
                                <FileDown className="w-4 h-4" fill="none" stroke="currentColor" />
                                Export as PDF
                            </button>
                            <button
                                onClick={() => HTML2Jpg(messageref.current, { IsDarkTheme: StateManager.get('isDarkTheme') })}
                                className="w-full px-4 py-2 text-left text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-primary-700 transition-colors flex items-center gap-2"
                            >
                                <Image className="w-4 h-4" fill="none" stroke="currentColor" />
                                Export as JPG
                            </button>
                            <button
                                ...
                                className="w-full px-4 py-2 text-left text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-primary-700 transition-colors flex items-center gap-2"
                            >
                                <Copy className="w-4 h-4" fill="none" stroke="currentColor" />
                                Copy as HTML
                            </button>
                            <button
