...
export const ChatOptions = ({ isOpen, onToggle }) => {
    ...
    return (
        <div
            ...
            className="fixed size-fit z-40 hidden"
            onClick={() => Manager.hideConversationOptions()}
        >
            {/* Conversation Options Tooltip */}
            <div
                id="chatOptions"
                className="absolute bg-white dark:bg-blend-900 rounded-lg shadow-lg z-50 border border-gray-200 dark:border-blend-200 backdrop-blur-sm min-w-fit animate-exit"
            ...
            <div
                id="renameModal"
                className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40 hidden"
                onClick={(e) => {
