...
export const Notifcation = ({ isOpen, onToggle }) => {
    return (
        <div id="intellideskNotify" className="fixed top-0 left-1/2 transform -translate-x-1/2 z-50 opacity-0 pointer-events-none transition-all duration-500 ease-in-out">
            {/* Modal Content */}
