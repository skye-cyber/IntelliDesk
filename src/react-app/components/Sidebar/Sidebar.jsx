    ...
    return (
        ...
        >
            ...
            <section data-action="options" className='ml-1 mt-0 space-y-0.5 text-gray-800 dark:text-white'>
                <div id="new-chat" className="flex items-center rounded-lg flex min-w-0 items-center gap-1.5 cursor-pointer hover:bg-gray-200 p-1.5 dark:hover:bg-blend-600">
