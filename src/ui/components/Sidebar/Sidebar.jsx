...
import { closePrefixed } from '../../../core/PortalBridge.ts';
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center justify-center space-x-2">
                        <div className="relative size-6 xl:size-8 bg-blue-500/0 rounded-lg flex items-center justify-center dark:shadow-lg cursor-pointer group transition-all duration-300">
                            ...
                            <PanelLeftClose onClick={togglePanel} className='text-gray-50 dark:text-gray-800' />
                            <span data-action='arial-title' className='absolute -bottom-2 z-[50] left-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 text-xs font-semibold text-primary-950 dark:text-gray-50 bg-primary-100/0 dark:bg-zinc-100/5 rounded-xl px-1 w-fit max-w-18 whitespace-pre font-handwriting'>Close</span>
                        </div>
                    </div>
