...
export const FieldGroup = ({ field, value, onUpdate, onRename, onDelete }) => {
    ...
    return (
        <div className="bg-gray-50 dark:bg-gray-800/50 rounded-xl p-4 hover:ring-1 hover:ring-indigo-200 dark:hover:ring-indigo-800 transition-all">
            <div className="flex justify-between items-center mb-3">
                    ...
                    {isEditingName ? (
                        <div className="flex items-center gap-2">
                            <input
                                ...
                                className="px-2 py-1 bg-white dark:bg-gray-700 border border-indigo-300 dark:border-indigo-600 rounded text-gray-900 dark:text-gray-100"
                                autoFocus
                            />
                            <button
                ...
                <div className="flex gap-2">
                    <button
                        ...
                        className="p-1.5 text-gray-500 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 rounded-lg transition-colors"
                        title="Rename field"
                    >
                        <Edit2 size={16} />
                    </button>
                    <button
                        ...
                        className="p-1.5 text-gray-500 dark:text-gray-400 hover:text-rose-600 dark:hover:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-900/20 rounded-lg transition-colors"
                        title="Delete field"
                    >
                        <Trash2 size={16} />
                    </button>
