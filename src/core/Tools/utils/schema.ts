/**
 * Contains Integrated schema for all available tools.
 * Schemas can also be found in individual tools.
 * So this is just a convenience module
 * @param {String} name Name for too to obtain schema for. Returns full schema if not specified.
 * @returns {dict} schema
 */
export function DefaultToolsSchema(name = null) {
    const baseSchemas = {
        search_web: {
            type: "function",
            function: {
...
export default DefaultToolsSchema
